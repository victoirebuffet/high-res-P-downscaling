...
def complex_cnn(layer_filters=[16, 64, 128], bn=True, padding='same', kernel_size=5,
...
def simple_cnn(layer_filters=[50, 32, 16], bn=True, padding='same', kernel_size=3,
...
def simple_dnn(dense_layers=[256, 11491], dense_activation='selu', input_shape=(60, 100, 10), dropout=0.6):
    """
...
def complex_dnn(dense_layers=[256], dense_activation='selu', input_shape=(60, 100, 10), dropout=0.6,
                         output_shape=11491):
    """
